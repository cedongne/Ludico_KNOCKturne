...
#include "HUDSpecialSkillHoverWidget.generated.h"

/**
 * 
 */
UCLASS()
class KNOCKTURNE_API UHUDSpecialSkillHoverWidget : public UUserWidget
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
	class UTextBlock* TextBlock_RemainTime;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (BindWidget))
