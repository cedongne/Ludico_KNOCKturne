...
{
	SCOPED_WWISERESOURCELOADER_EVENT(TEXT("SetLanguageAsync"));
	...
	Future.Next([this, OldLanguage = MoveTemp(OldLanguage), NewLanguage = MoveTemp(NewLanguage), Promise = MoveTemp(Promise)](int) mutable
	{
		...
		{
			SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("SetLanguageAsync Unloading"));
			...
			{
				SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("SetLanguageAsync Loading"));
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("LoadAuxBusAsync"));
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("UnloadAuxBusAsync"));
	FWwiseAsyncCycleCounter Timing(GET_STATID(STAT_WwiseResourceLoaderTiming));
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("LoadEventAsync"));
	FWwiseAsyncCycleCounter Timing(GET_STATID(STAT_WwiseResourceLoaderTiming));
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("UnloadEventAsync"));
	FWwiseAsyncCycleCounter Timing(GET_STATID(STAT_WwiseResourceLoaderTiming));
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("LoadExternalSourceAsync"));
	FWwiseAsyncCycleCounter Timing(GET_STATID(STAT_WwiseResourceLoaderTiming));
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("UnloadExternalSourceAsync"));
	FWwiseAsyncCycleCounter Timing(GET_STATID(STAT_WwiseResourceLoaderTiming));
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("LoadGroupValueAsync"));
	FWwiseAsyncCycleCounter Timing(GET_STATID(STAT_WwiseResourceLoaderTiming));
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("UnloadGroupValueAsync"));
	FWwiseAsyncCycleCounter Timing(GET_STATID(STAT_WwiseResourceLoaderTiming));
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("LoadInitBankAsync"));
	FWwiseAsyncCycleCounter Timing(GET_STATID(STAT_WwiseResourceLoaderTiming));
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("UnloadInitBankAsync"));
	FWwiseAsyncCycleCounter Timing(GET_STATID(STAT_WwiseResourceLoaderTiming));
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("LoadMediaAsync"));
	FWwiseAsyncCycleCounter Timing(GET_STATID(STAT_WwiseResourceLoaderTiming));
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("UnloadMediaAsync"));
	FWwiseAsyncCycleCounter Timing(GET_STATID(STAT_WwiseResourceLoaderTiming));
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("LoadShareSetAsync"));
	FWwiseAsyncCycleCounter Timing(GET_STATID(STAT_WwiseResourceLoaderTiming));
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("UnloadShareSetAsync"));
	FWwiseAsyncCycleCounter Timing(GET_STATID(STAT_WwiseResourceLoaderTiming));
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("LoadSoundBankAsync"));
	FWwiseAsyncCycleCounter Timing(GET_STATID(STAT_WwiseResourceLoaderTiming));
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("UnloadSoundBankAsync"));
	FWwiseAsyncCycleCounter Timing(GET_STATID(STAT_WwiseResourceLoaderTiming));
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("LoadAuxBusResources"));
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("LoadEventResources"));
	LogLoadResources(InCookedData);
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("LoadEventSwitchContainerResources"));
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("LoadGroupValueResources"));
	LogLoadResources(InCookedData);
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("LoadInitBankResources"));
	LogLoadResources(InCookedData);
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("LoadMediaResources"));
	LogLoadResources(InCookedData);
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("LoadShareSetResources"));
	LogLoadResources(InCookedData);
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("LoadSoundBankResources"));
	LogLoadResources(InCookedData);
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("LoadSwitchContainerLeafResources"));
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("UnloadAuxBusResources"));
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("UnloadEventResources"));
	LogUnloadResources(InCookedData);
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("UnloadEventSwitchContainerResources"));
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("UnloadExternalSourceResources"));
	LogUnloadResources(InCookedData);
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("UnloadGroupValueResources"));
	LogUnloadResources(InCookedData);
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("UnloadInitBankResources"));
	LogUnloadResources(InCookedData);
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("UnloadMediaResources"));
	LogUnloadResources(InCookedData);
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("UnloadShareSetResources"));
	LogUnloadResources(InCookedData);
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("UnloadSoundBankResources"));
	LogUnloadResources(InCookedData);
...
{
	SCOPED_WWISERESOURCELOADER_EVENT_2(TEXT("UnloadSwitchContainerLeafResources"));
...
{
	{
		SCOPED_WWISERESOURCELOADER_EVENT_4(TEXT("WaitForFutures"));
