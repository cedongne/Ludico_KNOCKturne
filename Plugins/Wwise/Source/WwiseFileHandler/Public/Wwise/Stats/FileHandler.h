...
DECLARE_MEMORY_STAT_EXTERN(TEXT("Prefetch Memory Allocated"), STAT_WwiseFileHandlerPrefetchMemoryAllocated, STATGROUP_WwiseFileHandler, WWISEFILEHANDLER_API);
